...
export default function Checklists() {
  ...
  // Auto-reset daily items for display
  ...
  return (
    <div className="pb-24 lg:pb-8">
      ...
      {/* Family-wide progress summary */}
      <FamilyProgressBar checklists={checklists} items={items} />

      {checklists.length === 0 ? (
        <div className="text-center py-20">
          <div className="w-20 h-20 rounded-3xl bg-primary/10 flex items-center justify-center mx-auto mb-4">
            <CheckSquare className="w-10 h-10 text-primary/50" />
          </div>
          <h2 className="font-heading text-xl font-semibold mb-2">No checklists yet</h2>
          <p className="text-muted-foreground mb-6 max-w-sm mx-auto text-sm">
            Create checklists for medications, pet feeding, school prep, and more. Everyone in the family can check off tasks.
          </p>
          <Button onClick={() => setCreateOpen(true)} className="rounded-xl gap-2">
